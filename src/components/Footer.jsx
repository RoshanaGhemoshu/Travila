  ...
  return (
    <footer className="bg-black text-white">
      ...
      <div className="w-full px-4 sm:px-6 lg:px-8 py-12">
        {/* Top Section */}
        <div className="flex items-center justify-between mb-16 pb-12 border-b border-gray-800 pl-30">
        ...
        <div className="grid grid-cols-5 gap-6 mb-12 pl-30">
          {/* Contact Info */}
          <div>
        ...
        {/* Bottom Bar */}
        <div className="border-t border-gray-800 pt-8 flex items-center justify-between pl-30">

...
<div className="bg-blue-50 py-20 relative overflow-hidden">
  ...
  <div className="w-full px-4 sm:px-6 lg:px-8">
    <div className="grid grid-cols-1 lg:grid-cols-5 gap-5 items-start">
      ...
      <div className="lg:col-span-2 pr-50">
        {/* Client Avatars */}
        ...
        <h2 className="text-4xl text-black mb-4 leading-tight">
...
<div className="bg-white py-20 pl-60">
  <div className="w-full px-4 sm:px-6 lg:px-8">
    <div className="flex items-center justify-between mb-12 pl-30">
      <div>
        <h2 className="text-7xl text-black font-bold mb-2">News, Tips & Guides</h2>

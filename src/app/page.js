...
<div className="bg-white py-4 border-b pr-20 mt-5">
  <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div className="bg-white rounded-full border border-gray-300 flex items-stretch mb-3 overflow-hidden h-17">
      ...
      <div className="flex-2 flex items-center gap-2 px-4 mr-2" style={{backgroundColor: '#F2F4F6'}}>
        ...
        <input
          ...
          className="flex-1 outline-none text-gray-900 text-xs bg-transparent py-3 placeholder:text-[#737373]"
        />
      </div>
...
<div className="w-full px-4 sm:px-6 lg:px-8">
  {/* Hero Title */}
  <div className="mb-8 sm:mb-12 flex flex-col sm:flex-row items-start justify-between gap-4 pl-30 mt-10">
  <div className="pl-50">
